...
app.use(function(req, res, next) { // insertamos siempre el usuario de nuestra session
...
app.use('/', require('./routes/index'),require('./routes/usuarios'),require('./routes/partidas'));
